...
Gem::Specification.new do |s|
  ...
  s.date = %q{2009-05-19}
  s.description = %q{http://www.factorylabs.com/images/cargo.png
...
This is still alpha}
  ...
  s.summary = %q{http://www.factorylabs.com/images/cargo.png  Cargo is a set of tools to help streamline using git}
